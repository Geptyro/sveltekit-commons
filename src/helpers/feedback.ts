...
export const DEFAULT_FEEDBACK_LIMITS: FeedbackLimits = {
	messageMin: 10,
	messageMax: 4000,
	nameMax: 80,
	contactMax: 120
 ...
 */
export function readFeedbackForm(form: FormData): FeedbackSubmission {
	const get = (field: string) => form.get(field);
	return {
		input: {
			message: get('message'),
			name: get('name'),
...
export function validateFeedback(
	input: FeedbackInput,
	limits: FeedbackLimits = DEFAULT_FEEDBACK_LIMITS
): FeedbackValidation {
